const PRESETS = [
  ...
  },
  {
    ...
    command: 'start /D "%cd%" powershell',
    commandWithArgs: 'start /D "{cwd}" powershell -NoExit -Command "{command}"',
  },
  {
    platform: "win32",
    name: "PowerShell 7",
    command: 'start /D "%cd%" pwsh',
    commandWithArgs: 'start /D "{cwd}" pwsh -NoExit -Command "{command}"',
  },
  {
    platform: "win32",
